...
import BasicInformations from "@/components/PatientsRegistration/BasicInformations";
import MedicalInfomations from "@/components/PatientsRegistration/MedicalInfomations";
  ...
  const onSubmit = async (values: z.infer<typeof PatientFormValidation>) => {
    ...
    try {
      ...
      if (step === 1) {
        ...
        router.replace(`/success/${patientPayload.name}`);
      }
    } catch (error) {
      console.log(error);
    } finally {
        ...
        <main>
          ...
          >
            ...
            {step === 1 ? (
              ...
              <MedicalInfomations form={form} editProfile={editProfile} />
            )}
